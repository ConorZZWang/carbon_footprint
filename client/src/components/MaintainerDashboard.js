...
// Updated department data with true green pastel color palette (no blue undertones)
    ...
    <div className="main-content">
      ...
      <div className="toolbar">
        ...
        <div className="nav-links">
          <button className="action-btn" onClick={() => navigate('/maintainer/profiles')}>Manage Profiles</button>
          <button className="action-btn" onClick={() => navigate('/maintainer/reports')}>View Reports</button>
      ...
      <div className="scrolling-content">
        <div className="hero-section">
          ...
          <p className="hero-description">
            Manage university sustainability efforts.
          </p>
        </div>
